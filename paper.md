...
- CGenFF data was gathered using our in-house SDF CGenFF version to enable us to make a workflow from SMILES to SDF (4) to CGenFF and obtain parameters
with penalties. 
...
# Applications to Cheminformatics
