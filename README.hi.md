...
| ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- |
| GlobalChem Chemical Entities          | GlobalChem में आंतरिक अणु वस्तुएं हैं जिनमें सभी सामान्य विशेषताएं जुड़ी हुई हैं और SMILES में रूपांतरण हैं                                       | बल क्षेत्र            |
...
| PDF Generation and Parsing            | GlobalChem SMILES से PDF जेनरेट कर सकता है और PDF को SMILES में बदल सकता है                                                                       | रसायन विज्ञान         |
...
-   **Plausabilitiy:**`GlobalChem`डेटा पर बनाया गया था जिसे पढ़ने और फिर से ड्राइंग का उपयोग करके किताबों और कागजों से निकाला गया था। यह का एक घटक जोड़ता है
