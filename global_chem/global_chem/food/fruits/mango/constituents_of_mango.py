...
class Mango(object):
  ...
  def get_smiles():
      ...
      smiles = {
        ...
        'alpha-terpinolene': "C/C(C)=C1CCC(C)C=C\1",
        ...
        'trans caryophyllene': 'C/C/1=C\CCC(=C)[C@H]2CC([C@@H]2CC1)(C)C  ',
        'sabinene': 'CC(C)C12CCC(=C)C1C2',
        'carene': 'CC1=CCC2C(C1)C2(C)C',
        'cis-caryophyllene': 'C/C/1=C/CCC(=C)[C@H]2CC([C@@H]2CC1)(C)C',
        'αlpha humulene': 'C/C/1=C\CC(/C=C/C/C(=C/CC1)/C)(C)C',
        ...
        'alpha bourbonene': 'CC1=CCC2C1C3C2(CCC3C(C)C)C',
