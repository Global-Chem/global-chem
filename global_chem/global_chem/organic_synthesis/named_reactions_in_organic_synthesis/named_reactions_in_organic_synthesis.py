...
class NamedReactionsInOrganicSynthesis(object):
  ...
  def get_smiles():
      ...
      smiles = {
        ...
        'perkin_reaction': r'O=CC1=CC=CC=C1.O=C(O)/C(C)=C\C2=CC=CC=C2',
	...
	'anionic_ortho-fries_rearrangement': 'O=C(C)OC1=CC=CC=C1.O=C(C)C2=C(O)C=CC=C2',
        ...
        'combes_quinoline_synthesis': 'NC1=CC=CC=C1.CC2=CC(C)=NC3=CC=CC=C32',
        'fischer_indole_synthesis': 'NNC1=CC=CC=C1.CC2=C(C)NC3=CC=CC=C32',
        'hofmann–löffler-freytag_reaction': 'CCCCCN([Cl,Br,I])C.CC1CCCN1C',
        'michael_addition': 'CC(CC(OCC)=O)=O.CC(C(C(OCC)=O)CCC(C)=O)=O',
        'von_pechmann_reaction': 'OC1=CC=CC=C1.CC(C2=CC=CC=C2O3)=CC3=O',
        'paal-knorr_furan_synthesis': 'CC(CCC(C)=O)=O.CC1=CC=C(C)O1',
        'paal-knorr_pyrrole_synthesis': 'CC(CCC(C)=O)=O.CC1=CC=C(C)N1C',
        'sandmeyer_reaction': 'NC1=CC=CC=C1.[F,Cl,Br,I]C2=CC=CC=C2',
        'schotten-baumann_reaction': 'CC(Cl)=O.CC(NC)=O',
        'buchner_method_of_ring_enlargement_buchner_reaction': 'C1=CC=CC=C1.O=C(OCC)C2C=CC=CC=C2',
        'curtius_rearrangement': 'CC(N=[N+]=[N-])=O.CN',
        'beckman_rearrangement': 'CC(=NO)C.CC(NC)=O',
        'knorr_pyrrole_synthesis': 'O=C(C(C)N)C.CC1=C(C(OCC)=O)C(C)=C(C)N1',
