const Graph = ForceGraph3D({controlType: "trackball"})(document.getElementById("3d-graph"));
...
let toggleData;
(toggleData = function () {
    curDataSetIdx = curDataSetIdx === undefined
        ? 0
        : (curDataSetIdx + 1) % dataSets.length;
    ...
    document
        .getElementById('graph-data-description')
